...
```{r hist_steps_by_day, fig.height=4, fig.width=4}
...
```{r ts_plot_avg_steps_by_interval}
...
```{r revised_hist_steps_by_day, fig.height=4, fig.width=4}
...
expect:
```{r display_revised_data_with_daytypes}
revised_data
```
...
```{r group_data_by_weekday_or_weekend}
